/**
 * @fileoverview Dev-only Telegram environment mock.
 * Calls mockTelegramEnv when running outside a real Telegram client in development.
 * The entire module is tree-shaken by Vite in production builds (import.meta.env.DEV is false).
 */
